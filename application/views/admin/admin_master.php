...
<html lang="en">
    <head>
        ...
        <title>DLOBL-একটি অনলাইন বাংলা সাহিত্য সংগ্রহশালা</title>
        <script type="text/javascript" src="<?php echo base_url(); ?>admin/jquery/jquery.js"></script>
        <script src="https://use.fontawesome.com/7a0f97050d.js"></script>
        ...
        <link href="<?php echo base_url(); ?>admin../build/css/liststyle.css" rel="stylesheet">
    </head>
            ...
            <div class="main_container">
                <div class="col-md-3 left_col">
                    <div class="left_col scroll-view">
                        <div class="navbar nav_title" style="border: 0;">
                            <a href="<?php echo base_url(); ?>ebook/admin" class="site_title"><i class="fa fa-superpowers" aria-hidden="true"></i> <span>পরিচালনা কেন্দ্র</span></a>
                        </div>
                        ...
                        <div class="profile">
                            <div class="profile_pic">
                                ...
                                foreach ($allData as $udt)
                                {
                                    ...
                                    <?php echo "<img src='" . base_url() . "uesrpic/upic_{$myid}.{$udt->picture}" . "' width='170' height='65' class='img-circle profile_img' alt='...' />"; ?>
                                    <?php
                                }
                                ?>
                            </div>
                            <div class="profile_info">
                                <span><h2>স্বাগতম</h3></span>
                                <h3>Admin</h3>
                            </div>
                        </div>
                        <!-- /menu profile quick info -->
                        ...
                        <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                            <div class="menu_section">
                                ...
                                <ul class="nav side-menu">
                                    <li><a href="<?php echo base_url(); ?>ebook/admin"><i class="fa fa-tachometer" aria-hidden="true"></i>
                                            Dashboard </a>
                                    ...
                                    <li><a><i class="fa fa-book" aria-hidden="true"></i> বই আপলোড <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="<?php echo base_url(); ?>books_management">Upload New Book</a></li>
                                            <li><a href="<?php echo base_url(); ?>books_management/view">View Books</a></li>
                                        </ul>
                                    </li>

                                    <li><a><i class="fa fa-book" aria-hidden="true"></i>বই এর বিভাগ সমূহ <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="<?php echo base_url(); ?>cat_management">Add New Category </a></li>
                                            <li><a href="<?php echo base_url(); ?>cat_management/view">View Category</a></li>
                                        </ul>
                                    </li>

                                    <li><a><i class="fa fa-book" aria-hidden="true"></i>বই এর উপবিভাগ সমূহ  <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="<?php echo base_url(); ?>subcat_Management">Add New Sub-Category</a></li>
                                            <li><a href="<?php echo base_url(); ?>subcat_Management/view">View Sub-Category</a></li>
                                        </ul>
                                    </li>

                                    <li><a><i class="fa fa-globe" aria-hidden="true"></i>Country <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="<?php echo base_url(); ?>country_management">Add New Country</a></li>
                                            <li><a href="<?php echo base_url(); ?>country_management/view">View Country</a></li>
                                        </ul>
                                    </li>

                                    <li><a><i class="fa fa-book" aria-hidden="true"></i>বই এর টেগ সমূহ<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="<?php echo base_url(); ?>tag_management">Add New Tag</a></li>
                                            <li><a href="<?php echo base_url(); ?>tag_management/view">View Tag</a></li>
                                        </ul>
                                    </li>

                                    <li><a><i class="fa fa-usd" aria-hidden="true"></i>Payment method<span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="<?php echo base_url(); ?>bank_management">Input bank name</a></li>
                                            <li><a href="<?php echo base_url(); ?>bank_management/view">View bank</a></li>
                                        </ul>
                                    </li>



                                    <li><a><i class="fa fa-user" aria-hidden="true"></i> User cpanel <span class="fa fa-chevron-down"></span></a>
                                        <ul class="nav child_menu">
                                            <li><a href="<?php echo base_url(); ?>personal">All user profile</a></li>
                        ...
                        <nav>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li class="">
                                    ...
                                    <a href="<?php echo base_url(); ?>admin/javascript" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                        ...
                                        foreach ($allData as $udt)
                                        {
                                            ...
                                            <?php echo "<img src='" . base_url() . "uesrpic/upic_{$myid}.{$udt->picture}" . "' width='100' height='60' />"; ?>
                                            <?php
                                        }
                                        ?>Admin
                                ...
                                <li role="presentation" class="dropdown">
                                    <a target="_blank" href="<?php echo base_url(); ?>profile/notification" class="dropdown-toggle info-number" aria-expanded="false">
                                        <i class="fa fa-envelope-o"></i>
                                        <?php
                                        foreach ($allp4m as $p4m)
                                        {
                                            if ($p4m->activation == 0)
                                            {
                                                ?>
                                                <span class="badge bg-red">NeN</span>
                                                <?php
                                                break;
                                            }
                                        }
                ...
                <footer>
                    <div class="pull-right">
                        Gentelella - Bootstrap Admin Template by <a href="<?php echo base_url(); ?>adminhttps://colorlib.com">Colorlib</a>
                    </div>
                    <div class="clearfix"></div>
                </footer>
                <!-- /footer content -->
